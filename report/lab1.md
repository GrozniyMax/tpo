...
1. **Базовые операции:**
   проверка корректной работы базовых операций коллекции

2. **Ребалансировка:**
   проверка правильности работы алгоритма ребалансировки
   
   Данный функционал не является частью API коллекции, поэтому для доступа к элементам использовалась рефлексия
