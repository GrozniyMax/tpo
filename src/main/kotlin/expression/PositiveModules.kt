 ...
 */
fun log10Squared(x: Double, epsilon: Double = 1e-10): Double {
 ...
 */
fun multiplyByLog2(x: Double, epsilon: Double = 1e-10): Double {
 ...
 */
fun addLog3(x: Double, epsilon: Double = 1e-10): Double {
 ...
 */
fun addLog5(x: Double, epsilon: Double = 1e-10): Double {
 ...
 * Вычисляет: ln(x) ^ 3
 */
fun lnCubed(x: Double, epsilon: Double = 1e-10): Double {
 ...
 */
fun positiveExpression(x: Double, epsilon: Double = 1e-10): Double {
