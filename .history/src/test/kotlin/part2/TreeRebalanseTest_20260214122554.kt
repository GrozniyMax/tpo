...
class TreeRebalanseTest {
    ...
    /*
     * Tree structure with 7 elements:
     * 
     *        4(B)
     *      /      \
     *    2(R)     6(R)
     ...
     *  1(B) 3(B) 5(B) 7(B)
     * 
     * This structure represents a balanced red-black tree with 7 elements.
     */
    ...
    fun setUp() {
        ...
        // Insert 7 elements to create a balanced tree
        tree.add(4)  // root
        tree.add(2)  // left child of root
        tree.add(6)  // right child of root
        tree.add(1)  // left child of 2
        tree.add(3)  // right child of 2
        tree.add(5)  // left child of 6
        tree.add(7)  // right child of 6
    }
